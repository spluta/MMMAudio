...
from examples.tests.TestODEOscillator import TestODEOscillator

struct MMMAudioBridge(Representable, Movable):
    var world: UnsafePointer[MMMWorld]  # Pointer to the MMMWorld instance

    var graph: TestODEOscillator  # The audio graph instance
...
@export
fn PyInit_TestODEOscillatorBridge() -> PythonObject:
    try:
