...
struct TestEnv(Movable, Copyable):
    ...
    def next(mut self) -> MFloat[8]:
        var line = self.line.next(0, 1.0, 0.1)
        var env_points = [(0.0, 0.0), (0.25, 2.0), (0.3, 0.5), (0.75, 0.5), (1.0, 0.0)]
        var env1 = env[WindowType.none](self.world, line, env_points)
        var env2 = env[WindowType.hann](self.world, line, env_points)
        var env3 = env[WindowType.sine](self.world, line, env_points)
        var env4 = env[WindowType.none](self.world, line, env_points, curve=2.0)
        var env5 = env[WindowType.none](self.world, line, env_points, curve=8.0)
        var env6 = env[WindowType.none](self.world, line, env_points, curve=0.5)
