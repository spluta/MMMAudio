...
def test_trand() raises:
    ...
    var trand0 = trand.next(10.0,20.0,False)
    assert_true(trand0 >= 10.0 and trand0 <= 20.0, "TRand initial output out of range")

    var trand1 = trand.next(10.0,20.0,True)
    ...
    # Test TExpRand
    var texprand = TExpRand()

    var texprand0 = texprand.next(10.0,20.0,False)
    assert_true(texprand0 >= 10.0 and texprand0 <= 20.0, "TExpRand initial output out of range")

    var texprand1 = texprand.next(10.0,20.0,True)
