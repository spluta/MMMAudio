...
mmm_audio.send_float("max_trig_rate", 100.0) # when the max trig rate creates more than the specified number of overlaps, TGrains will add voices to keep up with the trigger rate. 
