...
src_mojo = MMMAudio(128, graph_name="PanAzExample", package_name="examples", num_output_channels=8)
src_mojo.start_audio() 

src_mojo.send_int("num_speakers", 2 ) # set the number of speakers to between 2 and 8

src_mojo.send_int("num_speakers", 7 ) # set the number of speakers to between 2 and 8
src_mojo.send_float("width", 1.0 ) # set the width to 1.0 (one speaker at a time)
src_mojo.send_float("width", 3.0 ) # set the width to 3.0 (extra wide stereo width)
