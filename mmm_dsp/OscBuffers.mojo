...
struct OscBuffers(Representable, Movable, Copyable):
    ...
    fn __init__(out self):
        ...
        self.size_f64 = Float64(self.size)
        self.sinc_power_f64 = Float64(self.sinc_interpolator.sinc_power)  # Assuming sinc_power is 14
        self.max_layer = self.sinc_interpolator.sinc_power - 3
        self.size_f64_inv = 1.0 / Float64(self.size)
    ...
    fn read_sinc(self, phase: Float64, last_phase: Float64, buf_num: Int64) -> Float64:
        ...
        # Bit shifts (already optimal)
        spacing1 = 1 << layer
        spacing2 = spacing1 << 1
        
        # Index computation - use multiplication instead of modulo if possible
