...
from mmm_dsp.Analysis import MonoFreqAnalysis
...
struct TestYin(Movable, Copyable):
    ...
    var osc: Osc
    var mono_freq_analysis: MonoFreqAnalysis[1024, 512, 50.0, 5000.0]
    var freq: Float64
    var m: Messenger
    ...
    fn __init__(out self, world_ptr: UnsafePointer[MMMWorld]):
        ...
        self.mono_freq_analysis = MonoFreqAnalysis[1024, 512, 50.0, 5000.0](self.world_ptr)
        self.freq = 440.0
    ...
    fn next(mut self) -> SIMD[DType.float64, 2]:
        ...
        (frequency, confidence) = self.mono_freq_analysis.next(sample)
