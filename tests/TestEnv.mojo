...
struct TestEnv(Movable, Copyable):
    ...
    fn next(mut self) -> SIMD[DType.float64, 2]:
        ...
        self.env_params.time_warp = 1 #linexp(self.w[].mouse_x, 0.0, 1.0, 0.1, 10.0)
        self.env_params.curves[0] = linlin(self.w[].mouse_y, 0.0, 1.0, 4.0, 4.0)
        ...
        self.w[].print(self.env.rising_bool_detector.state, self.env.is_active, self.env.sweep.phase, self.env.sweep.phase, self.env.trig_point, self.env.last_asr)
