...
def main() raises:
    ...
    var results = SpectralSkewness.buf_analysis(buffer, chan=0, start_frame=0, num_frames=None, window_size=windowsize, hop_size=hopsize, padding=Padding.half_window)
   
    var pth = "testing_mmm_audio/validation/mojo_results/spectral_skewness_mojo_results.csv"
    try:
