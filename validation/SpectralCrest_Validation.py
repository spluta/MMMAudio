...
os.system("mojo run validation/SpectralCrest_Validation.mojo")
print("mojo analysis complete")

with open("validation/outputs/spectral_crest_mojo_results.csv", "r") as f:
    lines = f.readlines()
...
plt.savefig("validation/outputs/spectral_crest_comparison.png")
if show_plots:
    plt.show()
else:
    plt.close()
