...
from tests.TestBufferedProcessFFT import TestBufferedProcessFFT

struct MMMGraph(Representable, Movable):
    var world_ptr: UnsafePointer[MMMWorld]
    var graph_ptr: UnsafePointer[TestBufferedProcessFFT]
    ...
    fn __init__(out self, world_ptr: UnsafePointer[MMMWorld], graphs: List[Int64] = List[Int64](0)):
        ...
        self.graph_ptr = UnsafePointer[TestBufferedProcessFFT].alloc(1)
        __get_address_as_uninit_lvalue(self.graph_ptr.address) = TestBufferedProcessFFT(self.world_ptr)
