...
from examples.SpectralFreezeExample import SpectralFreezeExample

struct MMMGraph(Representable, Movable):
    var world_ptr: UnsafePointer[MMMWorld]
    var graph_ptr: UnsafePointer[SpectralFreezeExample]
    ...
    fn __init__(out self, world_ptr: UnsafePointer[MMMWorld], graphs: List[Int64] = List[Int64](0)):
        ...
        self.graph_ptr = UnsafePointer[SpectralFreezeExample].alloc(1)
        __get_address_as_uninit_lvalue(self.graph_ptr.address) = SpectralFreezeExample(self.world_ptr)
