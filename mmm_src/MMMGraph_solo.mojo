...
struct MMMGraph(Representable, Movable):
    ...
    var graph_ptr: UnsafePointer[Midi_Sequencer]
    ...
    fn __init__(out self, world_ptr: UnsafePointer[MMMWorld], graphs: List[Int64] = List[Int64](0)):
        ...
        self.graph_ptr = UnsafePointer[Midi_Sequencer].alloc(1)
        __get_address_as_uninit_lvalue(self.graph_ptr.address) = Midi_Sequencer(self.world_ptr)
