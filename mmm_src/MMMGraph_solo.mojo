...
from tests.TestCombAllpass import TestCombAllpass

struct MMMGraph(Representable, Movable):
    var world_ptr: UnsafePointer[MMMWorld]
    var graph_ptr: UnsafePointer[TestCombAllpass]
    ...
    fn __init__(out self, world_ptr: UnsafePointer[MMMWorld], graphs: List[Int64] = List[Int64](0)):
        ...
        self.graph_ptr = UnsafePointer[TestCombAllpass].alloc(1)
        __get_address_as_uninit_lvalue(self.graph_ptr.address) = TestCombAllpass(self.world_ptr)
